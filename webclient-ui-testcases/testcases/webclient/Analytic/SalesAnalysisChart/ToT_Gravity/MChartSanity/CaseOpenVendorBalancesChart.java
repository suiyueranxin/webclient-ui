...
public class CaseOpenVendorBalancesChart {
    
    @Test
    public void openVendorBalancesChart() {
        Home home = new Home();
        home.navigateToFromTiles(AnalyticPageString.AnalyticCategory + "->" + MultiFunctionalChartTitle.VendorBalancesChart);
        ...
        //chart bindings
        String measures = "Account Payable Balance (LC)";
