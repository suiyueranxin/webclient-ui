...
public class CaseOpenSalesAnalysisByDocumentChart {
    @Test
    public void openSalesAnalysisByDocumentChart() {
        Home home = new Home();
        home.navigateToFromTiles(AnalyticPageString.AnalyticCategory + "->" + MultiFunctionalChartTitle.SalesAnalysisByDocumentChart);
        ...
        //chart bindings
        String measures = "Net Sales Amount (LC),Open Amount (LC)";
