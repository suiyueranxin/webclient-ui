...
public class CaseOpenPurchaseAnalysisByDocumentChart {
    
    @Test
    public void openPurchaseAnalysisByDocumentChart() {
        Home home = new Home();
        home.navigateToFromTiles(AnalyticPageString.AnalyticCategory + "->" + MultiFunctionalChartTitle.PurchaseAnalysisByDocumentChart);
        ...
        //chart bindings
        String measures = "Net Purchase Amount (LC),Open Amount (LC)";
